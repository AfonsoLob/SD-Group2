...
public class MExitPoll extends UnicastRemoteObject implements IExitPoll_all {
    ...
    private final transient ILogger_ExitPoll logger; // Changed from ILogger_ExitPoll to ILogger_ExitPoll (transient as interface cannot be serialized)
    private final int localExitPollPercentage = 20;
    
    // Shutdown callback interface - REMOVED
    // Using PollingStation approach instead
